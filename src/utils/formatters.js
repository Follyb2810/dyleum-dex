...
export const urls = {
    showTransaction: (tx, chainId = 1116) => `${BLOCK_EXPLORER[chainId]}/tx/${tx}/`,
    showAddress: (address, chainId = 1116) =>
      `${BLOCK_EXPLORER[chainId]}/address/${address}/`,
    showToken: (address, chainId = 1116) =>
      `${BLOCK_EXPLORER[chainId]}/token/${address}/`,
    showBlock: (block, chainId = 1116) =>
