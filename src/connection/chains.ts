...
export const NETWORK_DETAILS = {
  MAINNET: {
    ...
    CORE: {
    chainId: `0x${SupportedChainId.CORE.toString(16)}`,
    chainName: CHAIN_IDS_TO_NAMES[SupportedChainId.CORE],
    chainRaw: SupportedChainId.CORE,
  },
  CORE_TESTNET: {
    chainId: `0x${SupportedChainId.CORE_TESTNET.toString(16)}`,
